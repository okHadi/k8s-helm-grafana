...
REQUEST_COUNT = Counter('app_request_count', 'Total app HTTP request count', registry=registry)
REQUEST_LATENCY = Histogram('app_request_latency_seconds', 'Request latency in seconds', registry=registry)
REDIS_COUNTER = Gauge('app_redis_counter', 'Current value of Redis counter', registry=registry)
